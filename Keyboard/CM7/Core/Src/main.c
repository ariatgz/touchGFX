...
/* Definitions for uart_data */
osMessageQueueId_t uart_dataHandle;
const osMessageQueueAttr_t uart_data_attributes = {
  .name = "uart_data"
};
/* USER CODE BEGIN PV */
...
/* USER CODE END Boot_Mode_Sequence_2 */
  ...
  /* Create the queue(s) */
  /* creation of uart_data */
  uart_dataHandle = osMessageQueueNew (2, sizeof(uart_d), &uart_data_attributes);
